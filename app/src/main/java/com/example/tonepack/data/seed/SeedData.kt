...
object SeedData {
    ...
    val templates = listOf(
        ...
        Template(
            ...
            content = "팀장님, 금주 업무 진행 현황 보고드립니다. 현재 A 프로젝트 기획안 검토 단계이며, 차주 수요일까지 최종안 제출 예정입니다. 상세 내용은 첨부파일 확인 부탁드립니다.",
            situation = "업무", target = "상사"
        ),
        Template(
            authorId = adminUser.id,
            title = "[요청] 신규 프로젝트 관련 회의 일정 조율",
            content = "대리님, 이번 프로젝트 기획 건으로 짧게 회의를 진행하고자 합니다. 이번 주 목요일 오후 2시 혹은 금요일 오전 10시 중 가능하신 시간이 있으실까요?",
        ...
        Template(
            ...
            content = "안녕하십니까, 000교수님.\n" +
                    ...
                    "\n" +
                    "다름이 아니라, 학술대회를 잘 마무리하고, 저희 논문 최종본을 교수님께 전달드리고자 메일을 드리게 되었습니다.\n" +
                    "파일 첨부로 논문 최종본을 보내드렸습니다.\n" +
                    "\n" +
                    "또한, 최종 논문 제출 전에 저희 프로젝트와 관련하여 최종 피드백을 받고자 교수님께 면담을 요청드리고 싶습니다.\n" +
                    "\n" +
                    "혹시 12월 4일 목요일 오후 3시에 면담이 가능하실지 여쭤보고 싶습니다.\n" +
                    "\n" +
        ...
        Template(
            ...
            content = "안녕하십니까,\n" +
                    ...
                    "\n" +
                    "새내기 새로배움터 소학회 홍보 시간에 사용할 자료 첨부합니다.\n" +
                    "\n" +
        ...
        Template(
            authorId = adminUser.id,
            title = "신청서 제출 문의",
            content = "안녕하십니까, 00학과 [학번] 전서연입니다.\n" +
                    "\n" +
                    "이번 학기에 소학회 신청서를 학과사무실에 제출하고자 이렇게 메일을 넣게되었습니다. 목요일 11시에 학과사무실에 찾아가도 괜찮을까요?\n" +
                    "\n" +
